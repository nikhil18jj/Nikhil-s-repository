...
prop=sum(us12$response == "atheist") / length(us12$response)
prop
```
...
fr12 <- subset(atheism, atheism$nationality == "France" &
                   atheism$year == "2012")
inference(fr12$response,data=fr12, statistic = "proportion", type = "ci",
          method = "theoretical", success = "atheist")

es12 <- subset(atheism, atheism$nationality == "Spain" &
                   atheism$year == "2012")
inference(af12$response,data=es12,statistic = "proportion", type = "ci",
        method = "theoretical", success = "atheist")
...
inference(es$response, as.factor(es$year),
          statistic = "proportion",data=es, type = "ht", method = "theoretical",
...
inference(us$response, as.factor(us$year),
          statistic = "proportion",data=us, type = "ht", method = "theoretical",
          null = 0, alternative = "twosided", success = "atheist")
```
